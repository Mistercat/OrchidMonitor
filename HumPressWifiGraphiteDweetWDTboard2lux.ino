...
/*  Serial.print("Ping:");
  ...
  if ( !wifi.ping(remote_ip, ping_report, 1, 56, 1000) ) {
...
//  client.println(" ");
  ...
  Serial.print(mPrefix);
  Serial.print(metric4);
  Serial.print(avgLux);
  Serial.print(" ");
  Serial.println(nn + TZ_OFFSET);
 
  client.print(mPrefix);
  client.print(metric4);
  client.print(avgLux);
  client.print(" ");
  client.println(nn + TZ_OFFSET);
  client.println(" ");
